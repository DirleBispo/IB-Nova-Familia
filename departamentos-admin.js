(function(){
  ...
  const canManage=()=>!!profile()?.ativo&&['pastor','admin','secretaria'].includes(profile()?.perfil);
  ...
  async function removeAssignment(id){
    ...
    if(!item||!confirm(`Retirar ${memberName(item)} da equipe de ${department(item.departamento)?.nome||'departamento'}?`))return;
